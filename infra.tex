...
\begin{document}
	...
	\subsection{Basics}
		...
		\begin{itemize}
			\item There is a difference between \texttt{abstract} and \texttt{public abstract} classes. An abstract class without any access level modifier is a \texttt{protected abstract} class.
			
			\item Unlike methods and fields, classes and interfaces only allow the two access level modifiers \texttt{public} and \texttt{abstract}.
