...
\begin{document}
	...
	There is a difference between \texttt{abstract} and \texttt{public abstract} classes. An abstract class without any access level modifier is a \texttt{protected abstract} class.
	
	Unlike methods and fields, classes and interfaces only allow the two access level modifiers \texttt{public} and \texttt{abstract}.
	...
	One can have protected fields in public abstract classes.
