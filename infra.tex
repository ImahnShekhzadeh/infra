...
\begin{document}
	...
	\subsection{Basics}
		...
		\begin{itemize}
			...
			\end{quote}}) or private, but not protected or package private.\footnote{It is generally the case that static methods cannot be \texttt{protected}, since they belong to the type where they are defined.}
