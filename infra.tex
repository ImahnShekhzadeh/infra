...
\begin{document}
	...
	\subsection{Merge Conflicts}
		...
		\begin{lstlisting}[style=mystylebash, alg:git_display, xleftmargin=\parindent]
			| LOCAL | BASE | REMOTE | 
					MERGED
		\end{lstlisting}
		...
		\begin{lstlisting}[style=mystylebash, alg:git_merge_view__actions, xleftmargin=\parindent]
			:diffg LO
			:diffg BA
			:diffg LO
		\end{lstlisting}
		...
		\begin{lstlisting}[style=mystylebash, alg=git:clean, xleftmargin=\parindent]
			git clean -f
		\end{lstlisting}

		Locally restore file
		
		\begin{lstlisting}[style=mystylebash, alg=git:restore, xleftmargin=\parindent]
		...
		\begin{lstlisting}[style=mystylebash, alg=git:dry_merge, xleftmargin=\parindent]
			git merge --no-commit --no-ff <branch_name>
		\end{lstlisting}

		Afterwards, type 

		\begin{lstlisting}[style=mystylebash, alg=git:abort_merge, xleftmargin=\parindent]
			git merge --abort
		\end{lstlisting}
		...
		\begin{lstlisting}[style=mystylebash, alg=git:ff_only, xleftmargin=\parindent]
