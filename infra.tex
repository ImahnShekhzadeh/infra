...
\begin{document}
	...
	There is a difference between \texttt{abstract} and \texttt{public abstract} classes. An abstract class is a \texttt{protected abstract} class.
	
	Unlike methods and variables, classes and interfaces only allow the two access level modifiers \texttt{public} and \texttt{abstract}.
	...
	Methods in interfaces are public and abstract by default. Hence the access modifiers do not need to be specified.
