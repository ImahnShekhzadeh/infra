...
\begin{document}
	...
	\begin{itemize} 		
		...
		\item If you had installed PyTorch via conda instead of pip, then this is easier, where \texttt{-E} means we are searching for extended regular expressions (\textbf{again activate the right conda env first!}):
